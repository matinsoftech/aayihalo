...
//   static List<CartDataModel> formatOnlineCartToLocalCart({required List<OnlineCartModel> onlineCartModel}) {
...
//       //      addOnsList, false, stock, cart.item, quantityLimit,
//       //   ),
//       // );
//     }
...
//   static String? setupVariationText({required CartDataModel cart}) {
...
//   static String? setupAddonsText({required CartDataModel cart}) {
//     String addOnText = '';
//     int index0 = 0;
//     List<int?> ids = [];
//     List<int?> qtys = [];
...
//   static double getItemDetailsDiscountPrice({required CartDataModel cart}) {
