...
//   // static double calculateAddonsPrice({required Store? store, required List<CartDataModel?>? cartList}) {
//   //   double addOns = 0;
...
//   // static double calculateVariationPrice({required Store? store, required List<CartDataModel?>? cartList, bool calculateDiscount = false, bool calculateWithoutDiscount = false}) {
...
//   static double calculatePrice({required Store? store, required List<CartDataModel?>? cartList}) {
//     double price = 0;
//     // if(cartList != null) {
//     //   for (var cartModel in cartList) {
//     //     if(Get.find<SplashController>().getModuleConfig(cartModel!.item!.moduleType).newVariation!){
...
//   static double calculateDiscount({required Store? store, required List<CartDataModel?>? cartList, required double price, required double addOns}) {
//     double discount = 0;
//     // if (store != null && cartList != null) {
//     //   for (var cartModel in cartList) {
...
//   static double calculateSubTotal({required double price, required double addOns, required double variations, required List<CartDataModel?>? cartList}) {
//     double subTotal = 0;
...
//   static double calculateOrderAmount({required double price, required double variations, required double discount, required double addOns, required double couponDiscount, required List<CartDataModel?>? cartList}) {
