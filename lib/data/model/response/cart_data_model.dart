...
enum AddOnIds { ADD_ON_IDS, EMPTY }

final addOnIdsValues = EnumValues({"\"[]\"": AddOnIds.ADD_ON_IDS, "[]": AddOnIds.EMPTY});
...
enum DiscountTypeEnum { PERCENT }

final discountTypeEnumValues = EnumValues({"percent": DiscountTypeEnum.PERCENT});
...
enum Key { DESCRIPTION, NAME, UNIT }

final keyValues = EnumValues({"description": Key.DESCRIPTION, "name": Key.NAME, "unit": Key.UNIT});

enum Locale { EN }

final localeValues = EnumValues({"en": Locale.EN});

enum ItemTypeEnum { APP_MODELS_ITEM, APP_MODELS_UNIT }

final itemTypeEnumValues = EnumValues({"App\\Models\\Item": ItemTypeEnum.APP_MODELS_ITEM, "App\\Models\\Unit": ItemTypeEnum.APP_MODELS_UNIT});
