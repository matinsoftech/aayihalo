...
// if (json['category_ids'] != null) {
//       categoryIds = [];
//       List<dynamic> parsedCategoryIds = jsonDecode(json['category_ids']);
//       parsedCategoryIds.forEach((v) {
//         categoryIds!.add(CategoryIds.fromJson(v));
//       });
...
//     }
    ...
    if (json['food_variations'] != null) {
      if (json['food_variations'] is String) {
        List<dynamic> parsedFoodVariations =
            jsonDecode(json['food_variations']);
        parsedFoodVariations.forEach((v) {
          foodVariations!.add(FoodVariation.fromJson(v));
        });
    ...
    addOns = [];
    if (json['add_ons'] != null) {
      if (json['add_ons'] is String && json['add_ons'].startsWith('[')) {
        List<dynamic> parsedAddOns = jsonDecode(json['add_ons']);
        parsedAddOns.forEach((v) {
          addOns!.add(AddOns.fromJson(v));
        });
    ...
    if (json['choice_options'] != null) {
      ...
      if (json['choice_options'] is String) {
        List<dynamic> parsedChoiceOptions = jsonDecode(json['choice_options']);
        parsedChoiceOptions.forEach((v) {
          choiceOptions!.add(ChoiceOptions.fromJson(v));
        });
...
class CategoryIds {
  ...
  CategoryIds({required this.id, required this.position});
