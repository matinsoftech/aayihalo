...
class NewItemsView extends StatefulWidget {
  ...
  const NewItemsView({Key? key, required this.stores, required this.items, required this.isStore, this.isScrollable = false, this.shimmerLength = 20, this.padding = const EdgeInsets.all(Dimensions.paddingSizeSmall), this.noDataText, this.isCampaign = false, this.inStorePage = false, this.isFeatured = false, this.isFoodOrGrocery = true}) : super(key: key);

  @override
  State<NewItemsView> createState() => _ItemsViewState();
}

class _ItemsViewState extends State<NewItemsView> {
  @override
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return
                        ...
                        Center(
                      child: ItemShimmer(isEnabled: isNull, isStore: widget.isStore, hasDivider: index != widget.shimmerLength - 1),
                    );
                  },
                ),
              ),
