  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            (ResponsiveHelper.isDesktop(context) && orderController.orderDetails!.isNotEmpty)
                ? Container(
                    decoration: BoxDecoration(
            ...
            Align(alignment: Alignment.topLeft, child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSmall), child: Text('order_summary'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)))),
                  ...
                  parcel
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Get.find<SplashController>().getModuleConfig(order.moduleType).addOn!
                                ? Divider(
                                    thickness: 1,
            ...
            ResponsiveHelper.isDesktop(context) ? Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault), child: bottomView) : const SizedBox(),
          ],
        ),
      ),
    );
