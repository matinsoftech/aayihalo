                        ...
                        showVideoAndServices ? Expanded(
                          child: parcelController.videoContentDetails!.bannerType == 'image' ? ClipRRect(
                            ...
                            child: CustomImage(image: '${parcelController.videoContentDetails!.promotionalBannerUrl}/${parcelController.videoContentDetails!.bannerImage}'),
                              ...
                              : parcelController.videoContentDetails!.bannerType == 'video' ? GetServiceVideo(youtubeVideoUrl: parcelController.videoContentDetails!.bannerVideo ?? '', fileVideoUrl: '',)
                              : GetServiceVideo(youtubeVideoUrl: '', fileVideoUrl: '${parcelController.videoContentDetails!.bannerVideoContentUrl!}/${parcelController.videoContentDetails!.bannerVideoContent!}'),
                        ) : const SizedBox(),
