            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  Text(isCheckOut ? 'Select your location' : '${'hey_welcome_back'.tr}\n${'which_location_do_you_want_to_select'.tr}', style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  const SizedBox(height: Dimensions.paddingSizeLarge),
                  Center(
                    child: locationController.addressList != null && locationController.addressList!.isEmpty
                  ...
                  locationController.addressList != null && locationController.addressList!.isEmpty ? const SizedBox(height: Dimensions.paddingSizeLarge) : const SizedBox(),
                  ...
                  Align(
                    ...
                    child: TextButton.icon(
                      ...
                      style: TextButton.styleFrom(
                        ...
                        backgroundColor: locationController.addressList != null && locationController.addressList!.isEmpty ? Theme.of(context).primaryColor : Colors.transparent,
                      ),
                      icon: Icon(Icons.my_location, color: locationController.addressList != null && locationController.addressList!.isEmpty ? Theme.of(context).cardColor : Theme.of(context).primaryColor),
                      label: Text('use_current_location'.tr,
                          style: fromDialog
                              ? robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: locationController.addressList != null && locationController.addressList!.isEmpty ? Theme.of(context).cardColor : Theme.of(context).primaryColor)
                              : robotoMedium.copyWith(color: locationController.addressList != null && locationController.addressList!.isEmpty ? Theme.of(context).cardColor : Theme.of(context).primaryColor)),
                    ),
                  ),
