...
//   final bool fromCart;
//   final int? storeId;
//   const CheckoutScreen({key, required this.fromCart, required this.cartList, required this.storeId}) : super(key: key);
...
//             if(_cartList != null){
//               for (CartDataModel? cart in _cartList!) {
...
//                 CartDataModel cart = _cartList![index]!;
