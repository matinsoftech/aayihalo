...
//     key, this.storeId, required this.storeController, this.cartList, required this.tooltipController2,
...
//       !isGuestLoggedIn && storeId == null && storeController.store!.scheduleOrder! && cartList![0]!.item!.availableDateStarts == null ? Container(
...
//       SizedBox(height: !isGuestLoggedIn && storeId == null && storeController.store!.scheduleOrder! && cartList![0]!.item!.availableDateStarts == null ? Dimensions.paddingSizeSmall : 0),
